...
extern struct _keyCodes*  parseKeyData(char *keyFileName);
extern void keyMapCleanup();
...
protected:
    ...
    int VKLookup(unsigned char irNumber, unsigned char irDevice, unsigned int* key, bool* isKeypad, bool *isLowercase);
